          ...
          >
            <div className="p-6 bg-dark rounded-xl h-full border border-primary/10">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-light/80">Monohardi, Narsingdi, Bangladesh</p>
              </div>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <a href="mailto:nafim3344@gmail.com" className="text-light hover:text-primary transition-colors">
                  nafim3344@gmail.com
                </a>
              </div>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <a href="tel:+8801708965600" className="text-light hover:text-primary transition-colors">
                  +880 1708 965600
                </a>
              </div>
            </div>
